$(document).ready(function() {
	...
	$('#search-button').click(function() {
        // Convert the checkedAmenities object to a JSON string
        var amenitiesJson = JSON.stringify(checkedAmenities);

        // Call the listPlaces function with the amenities as an argument
        listPlaces(amenitiesJson);
